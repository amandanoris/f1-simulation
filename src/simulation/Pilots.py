...
from Race import Difficulty, Weather
import names
import random
from Driving import DrivingStyle, GeneticStrategySelection
...
class Pilot(Agente):
    ...
    def generate_random_pilot(creencias=False, sistema_mensajeria=False, do_pitstop=False, no_stops=0):
        ...
        # Crear el objeto Pilot con los valores generados aleatoriamente
