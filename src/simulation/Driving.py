import random
import math
from Tires import  C0Tire, C1Tire, C2Tire, C3Tire, GreenIntermediateTire,FullWetBlueTire
...
segment = Segment(1000, 9,10) 

g = GeneticStrategySelection()

# Llamar a la función de búsqueda genética
mejor_estilo = g.busqueda_genetica( segment)

# Imprimir el mejor estilo de conducción encontrado
print("Mejor estilo de conducción:", mejor_estilo.aceleracion,  + mejor_estilo.cautela, + mejor_estilo.braking_strategy )
